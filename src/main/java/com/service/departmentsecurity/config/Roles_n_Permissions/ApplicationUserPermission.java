...
public enum ApplicationUserPermission {
    CLIENT_READ("client:read") , CLIENT_WRITE("client:write") , CLIENT_CONTACT("client:contact") ,

    PRODUCT_READ("product:read") , PRODUCT_WRITE("product:write") , PRODUCT_BUY("product:buy") , PRODUCT_SELL("product:sell"),
